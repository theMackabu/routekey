      ...
      <Headless.Combobox {...props} multiple={false} virtual={{ options: filteredOptions }} onClose={() => setQuery('')}>
         <span
            ...
            className={clsx([
               ...
               'after:pointer-events-none after:absolute after:inset-0 after:rounded-md after:ring-transparent after:ring-inset sm:focus-within:after:ring-2 sm:focus-within:after:ring-[#7957D9]',
            ...
            <Headless.ComboboxInput
               ...
               className={clsx([
                  ...
                  'border border-zinc-950/10 data-hover:border-[#7957D9]',
                  'bg-white/5',
         ...
         <Headless.ComboboxOptions
            ...
            className={clsx(
               ...
               'bg-white/75 backdrop-blur-xl z-[100]',
   ...
   return (
      <Headless.ComboboxOption
         ...
         className={clsx(
            ...
            'outline-hidden data-focus:bg-[#7957D9] data-focus:text-white',
